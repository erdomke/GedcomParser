  ...
  internal class TimelineRenderer
  {
    ...
    public XElement Render(IEnumerable<ResolvedFamily> families, string baseDirectory)
    {
      ...
      for (var i = 0; i <= lineCount; i++)
      {
        ...
        grid.Add(new XElement(Svg.Ns + "line"
        ...
        if (i < lineCount)
        {
          grid.Add(new XElement(Svg.Ns + "text"
    ...
    private class EventLink : Shape
    {
      ...
      public override IEnumerable<XElement> ToSvg()
      {
        ...
        if (nodes.Count > 1)
        {
          group.Add(new XElement(Svg.Ns + "line"
        ...
        {
          group.Add(new XElement(Svg.Ns + "circle"
    ...
    private class IndividualTimeline : Shape
    {
      ...
      {
        _group = new XElement(Svg.Ns + "g", new XAttribute("id", individual.Id.Primary));
      ...
      public void SetPosition(DateTime startDate, double pxPerDay, IGraphics graphics)
      {
        ...
        _group.Add(new XElement(Svg.Ns + "rect"
        ...
        _group.Add(new XElement(Svg.Ns + "text"
